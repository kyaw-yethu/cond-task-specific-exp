"""Tests for the pieces ``conditioning.lib.dit_eval`` adds on top of the original.
...
def test_gt_pose_matches_to_ego_frame_on_arrays():
    from conditioning.lib.traj_metrics import to_ego_frame
