...
# node_chain.sh, then the qualitative comparison and STAGE1_K1_RESULTS.md.
#
...
FIXED_K=1 bash conditioning/scripts/node_chain.sh 0 G1:vjepa2:vjepa2_G_vith256:2      > out/logs/k1_chain0.log 2>&1 &
FIXED_K=1 bash conditioning/scripts/node_chain.sh 1 D1:drivejepa:drivejepa_D_vitl256:2 > out/logs/k1_chain1.log 2>&1 &
FIXED_K=1 bash conditioning/scripts/node_chain.sh 2 T1:drivejepa:drivejepa_T_vitl256:2 > out/logs/k1_chain2.log 2>&1 &
FIXED_K=1 bash conditioning/scripts/node_chain.sh 3 V1:traj_vae:waypoint_vae_lr5x:1    > out/logs/k1_chain3.log 2>&1 &
FIXED_K=1 bash conditioning/scripts/node_chain.sh 3 N1:none:-:0                        > out/logs/k1_chain4.log 2>&1 &
wait
