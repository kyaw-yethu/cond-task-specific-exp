...
Loads a `scripts/train_dit_cond.py` checkpoint, which `f_toy`'s `load_dit` cannot
...
Usage:
    python scripts/eval_cond.py --jdm third_party/Task_specific_JDM --dataset waymo \\
...
from cond_eval.cond_dit import ConditionedDiT, CrossAttnConditioner
from cond_eval.dit_eval import condition_raw_frame_cutoff, run_dit_eval
from cond_eval.pose_probe import build_pose_fn
