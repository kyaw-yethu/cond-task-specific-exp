...
carry NaN and are dropped rather than interpolated.
    ...
    python scripts/plot_cond_curves.py --ckpt-dir checkpoints/waymo --out out/cond_curves.png
    python scripts/plot_cond_curves.py --suffix 1 --out out/cond_curves_k1.png \
