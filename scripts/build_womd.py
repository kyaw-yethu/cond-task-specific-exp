...
def _convert(shard):
    from cond_eval.womd.convert import convert_shard
...
if __name__ == "__main__":
    ...
    if a.stage == "convert":
        ...
        from cond_eval.womd.select import stage_select
        stage_select(SD_ROOT, WORK, SHARDS)
    elif a.stage == "render":
        from cond_eval.womd.render import stage_render
        stage_render(SD_ROOT, WORK, OUT, a.split, a.workers)
    elif a.stage == "finalize":
        from cond_eval.womd.finalize import stage_finalize
