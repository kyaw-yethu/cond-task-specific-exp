...
encoder instead of every epoch. See `cond_eval.cached` for why k is fixed and
what it costs.
...
Usage:
    python scripts/build_cache.py --jdm third_party/Task_specific_JDM --dataset waymo \\
...
from cond_eval.cached import read_cache_meta, write_cache_meta
