...
| path | contents |
|---|---|
| `cond_eval/dg_eval/` | `nusc_index.py`, `clips.py` (both geometries), `extract.py`, `score.py` |
| `scripts/dg_*.py` | build, extract, score, summary, analyse, table, ftd, diagnose, roi test, plot |
